...
BuildSolid is a personal learning project shared freely for others to use and adapt. The creator intends to keep it free and open source, with no paid offerings or current plans to commercialize it. Active framework development has concluded. Hypothetical future permissions elsewhere in this constitution are safeguards for evaluating a separately proposed change, not an active roadmap or a commitment to further development.
